...
-   [`bumbl`](https://github.com/Aariq/bumbl) 📦 fits switchpoint GLMs to model bumblebee colony growth data

-   [`bdffpRain`](https://github.com/BrunaLab/BDFFP-precipitation) 📦 is a bi-lingual data package for precipitation data from the Biological Dynamics of Forest Fragments Project
...
::: incremental
-   Data quality assurance with `pointblank` 📦
